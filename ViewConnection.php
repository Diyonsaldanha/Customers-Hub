...
<html lang="en">
  ...
  <body>
      <div class="container pt-4 ">
          <h3 style="color:#cc33ff">Connection request</h3>
      </div>
...
//Check
  ...
  $sql = "select * FROM new_connection"; //You don't need a ; like you do in SQL
  ...
  <tr>
    ...
    <th><strong>Connection description</strong></th>
  </tr>";
