          ...
          <div class="p-4">
            <form action="login_admin.php" method="post">
             ...
             <div style="padding-top: 20px;">
              <p>Doesn't have an account?  <strong><a href="register.html">Register Here</a></strong></p>
             </div>
          </div>
...
mysqli_select_db($con,'db_CustomerHub');

if(isset($_POST['login_btn'])) {
  $id = $_POST['id'];
  $pass = $_POST['password'];

  $s = "select Admin_id from admin where Admin_id='$id' and Admin_password='$pass'";
  ...
  if ($num == 1) {
      ...
      echo"
      <div class=' p-4' style='padding:50px;'>
