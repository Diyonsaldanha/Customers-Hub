...
<html lang="en">
              ...
              <div class="p-4">
                <form action="NewConnection.php" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="Con_desc" id="" cols="30" rows="5">Write connection description here...</textarea>
                  </div>
  ...
  if(isset($_POST['submit'])){
    ...
    $Con_desc= $_POST['Con_desc'];
      ...
      $sql= "INSERT INTO db_CustomerHub.new_connection VALUES('".$Custid."','".$name."','".$address."','".$phone."','".$Con_desc."')";
